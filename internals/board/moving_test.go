...
func TestMove(t *testing.T) {
	...
	assert.Equal(t, State("[0,0,0,0,1,0,0]"), myBoard.ToState())
}
...
func TestTwoMovesInTwoLines(t *testing.T) {
	...
	assert.Equal(t, State("[0,0,0,2,1,0,0]"), myBoard.ToState())
}
...
func TestTwoMovesInSameLine(t *testing.T) {
	...
	assert.Equal(t, State("[0,0,0,0,7,0,0]"), myBoard.ToState())
}
